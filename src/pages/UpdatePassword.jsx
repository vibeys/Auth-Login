...
export default function UpdatePassword() {
  ...
  // Detect if the user signed in with Google (no password set)
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (isGoogleUser) {
        // Google users don't have a "current password" — re-auth with Google popup
    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-card">
        <div className="card-header">
          ...
          <p>
            {isGoogleUser
              ? "Set a password for your account (you'll be asked to verify with Google)"
        ...
        {success && (
          <div className="success-banner">
            <FiCheck />&nbsp;Password updated! Redirecting…
          </div>
        )}
        {error && (
